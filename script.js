...
// 🔴 விடுபட்ட பகுதி - பட்டன்களை அழுத்தினால் அடுத்த ஸ்டெப் ஓபன் ஆகும் துல்லியமான லாஜிக்
function toggleContent(id) {
    var x = document.getElementById(id);
    if (!x) return;
    
    // தற்போதைய டிஸ்பிளே ஸ்டேட்டைக் கணக்கிடுகிறது
    var currentDisplay = window.getComputedStyle(x).display;

    if (currentDisplay === "block") {
        x.style.display = "none";
    } else {
        // மற்ற எல்லா அக்கார்டியன் பாக்ஸ்களையும் மூடுகிறது
        var boxes = document.getElementsByClassName("content-box");
        for (var i = 0; i < boxes.length; i++) {
            boxes[i].style.display = "none";
        }
        // கிளிக் செய்த பாக்ஸை மட்டும் திறக்கிறது
        x.style.display = "block";
        
        // மொபைலில் தானாக ஸ்க்ரோல் செய்யும் வசதி
        setTimeout(function() {
